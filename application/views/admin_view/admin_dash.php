          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0">List Job</h1>
...
?>
  ...
  <div class="card-body">
    ...
    <div class="row justify-content-center">
          ...
          <a href="edit_page/<?php echo $data->job_id?>"><button class="customPrevBtn btn btn-primary m-1">Edit</button></a>
          <a href="application/<?php echo $data->job_id?>">  <button class="customNextBtn btn btn-primary m-1">Aplcn</button></a>
          </div>
        </div>
