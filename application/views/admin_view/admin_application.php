          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0">Job Applicants</h1>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
        ...
        <tr>
          ...
          <td><a href="<?php echo base_url('index.php/Welcome/add')?>/<?php echo $row->apply_id?>"><button class="btn btn-success">Add</button></td></a>
          <?php $this->session->set_userdata( array( 'job_id'  =>$row->job_id));?>
          <td><a href="<?php echo base_url('index.php/Welcome/remove')?>/<?php echo $row->apply_id?>"><button class="btn btn-danger">Remove</button></td></a>
