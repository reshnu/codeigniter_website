          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <li><a href="<?php echo base_url('')?>index.php/Welcome/admin_homepage"class="nav-link active">Add Job</a></li>
      ...
      <div class="slide-1" style="background-image: url('<?php echo base_url('')?>assets/images/hero_1.jpg');" data-stellar-background-ratio="0.5">
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  <h1  data-aos="fade-up" data-aos-delay="100">Add Job </h1>
                ...
                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form action="<?php echo base_url('')?>index.php/Welcome/add_job" method="post" class="form-box">
				<span class="redcolor">	<?php echo $this->session->flashdata('add_job')?></span>
        <span style="color:green">	<?php echo $this->session->flashdata('success')?></span>
					...
					<label for="email">Job Title  <span class="redcolor">*</span></label>	
                      <input type="text" name="title" class="form-control" placeholder="Eg.Sales Executive Needed urgently..." required>
					</div>
                    ...
                    <input type="text" name="role" class="form-control" list="job" required/>
                     <datalist id="job">
...
<div class="form-group">
                    ...
                    <input type="text" name="dist" class="form-control" list="dist" required/>
<datalist id="dist">
...
<div class="form-row">
    <div class="col">
      <input type="text" name="minsal" class="form-control" placeholder="Min Salary" required>
    </div>
    <div class="col">
      <input type="text" name="maxsal" class="form-control" placeholder="Max Salary" required>
    </div>
  </div>
  </div>
...
<div class="form-row">
    <div class="col">
      <input type="text" name="minexp" class="form-control" placeholder="Min Exp" required>
    </div>
    <div class="col">
      <input type="text" name="maxexp" class="form-control" placeholder="Max Exp" required>
    </div>
  </div>
  </div>
					...
					<label for="email">Job Description  </label>
                      <input type="text" name="jobdesc" class="form-control" placeholder="Job Details" >
                    </div>

                    <div class="form-group">
                      <input type="submit" class="btn btn-primary btn-pill" value="Add Job">
